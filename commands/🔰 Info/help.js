  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("871386059110502441").setLabel("nerdgamehouse").setURL("https://www.instagram.com/nerdgamehouse/")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
...
.addField("How to get help?", `>>> **\` 1. Way \`** *Use the Buttons, to swap the Pages*\n**\` 2. Way \`** *Use the Menu to select all Help Pages, you want to display*\n\``)
        ...
        function allotherembeds_eachcategory(filterdisabled = false){
          ...
          var embed1 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "💸 Economy").size}\`] 💸 Economy Commands 💸 | ${settings.ECONOMY ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed2 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🏫 School Commands").size}\`] 🏫 School Commands 🏫 | ${settings.SCHOOL ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed3 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎶 Music").size}\`] 🎶 Music Commands 🎶 | ${settings.MUSIC ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed4 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "👀 Filter").size}\`] 👀 Filter Commands 👀 | ${settings.FILTER ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed5 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "⚜️ Custom Queue(s)").first().extracustomdesc.length}\`] ⚜️ Custom Queue(s) Commands ⚜️ | ${settings.CUSTOMQUEUE ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed10 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "⌨️ Programming").size}\`] ⌨️ Programming Commands ⌨️ | ${settings.PROGRAMMING ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed11 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "📈 Ranking").size}\`] 📈 Ranking Commands 📈 | ${settings.RANKING ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed12 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🔊 Soundboard").size}\`] 🔊 Soundboard Commands 🔊 | ${settings.SOUNDBOARD ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed13 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎤 Voice").first().extracustomdesc.length}\`] 🎤 Voice Commands 🎤 | ${settings.VOICE ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed14 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🕹️ Fun").size}\`] 🕹️ Fun Commands 🕹️ | ${settings.FUN ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed15 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🎮 MiniGames").size}\`] 🎮 Mini Games Commands 🎮 | ${settings.MINIGAMES ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
            .addField("\u200b", "__**Sub-Categorized Commands:**__")
          ...
          var embed16 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "😳 Anime-Emotions").size}\`] 😳 Anime Commands 😳 | ${settings.ANIME ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
          ...
          var embed17 = new MessageEmbed()
            .setTitle(`[\`${client.commands.filter((cmd) => cmd.category === "🔞 NSFW").size}\`] 🔞 NSFW Commands 🔞 | ${settings.NSFW ? "<a:Check_List_Ijo:878170554815905792> ENABLED" : "<:no:833101993668771842> DISABLED"}`)
