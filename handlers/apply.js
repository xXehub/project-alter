  ...
  const Buttons = {
    acceptbutton: new MessageButton().setStyle('SUCCESS').setEmoji(`<a:Check_List_Ijo:878170554815905792>`).setCustomId(`Apply_accept`).setLabel(`Accept`),
    declinebutton: new MessageButton().setStyle('DANGER').setEmoji(`<:no:939372664559132723>`).setCustomId(`Apply_deny`).setLabel(`Decline`),
    ticketbutton: new MessageButton().setStyle('SECONDARY').setEmoji(`❓`).setCustomId(`Apply_ticket`).setLabel(`Ask Question`),
    ...
    acceptbutton_d: new MessageButton().setStyle('SUCCESS').setEmoji(`<a:Check_List_Ijo:878170554815905792>`).setCustomId(`Apply_accept`).setLabel(`Accept`).setDisabled(true),
    declinebutton_d: new MessageButton().setStyle('DANGER').setEmoji(`<:no:939372664559132723>`).setCustomId(`Apply_deny`).setLabel(`Decline`).setDisabled(true),
    ticketbutton_d: new MessageButton().setStyle('SECONDARY').setEmoji(`❓`).setCustomId(`Apply_ticket`).setLabel(`Ask Question`).setDisabled(true),
        ...
        async function send_finished() {
          if (apply_db.get(guild.id, `${pre}.last_verify`)) {
            user.send({embeds: [new Discord.MessageEmbed()
              ...
              msg.react(`<a:Check_List_Ijo:878170554815905792>`)
              msg.react(`<:no:939372664559132723>`)
              ...
              msg.awaitReactions({filter, 
                ...
                .then(async collected => {
                  ...
                  if (reaction.emoji?.name === `<a:Check_List_Ijo:878170554815905792>`) {
      ...
      if (interaction?.customId.startsWith(`Apply_`)) {
          ...
          try {
            ...
            if (!oldEmbed)
              ...
              let emoji = {
                "Apply_accept": `<a:Check_List_Ijo:878170554815905792>`,
                "Apply_deny": `<:no:939372664559132723>`,
                "Apply_ticket": `❓`,
                // "Apply_1": `1️⃣`,
                // "Apply_2": `2️⃣`,
                // "Apply_3": `3️⃣`,
